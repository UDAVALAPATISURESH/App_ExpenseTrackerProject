  ...
  try {
    ...
    if (!newPassword) {
      if (typeof showNotification === 'function') {
        showNotification("Please enter a new password", 'warning', 'Validation Error');
      } else {
    ...
    if (typeof showNotification === 'function') {
      showNotification(error.response?.data?.message || "Failed to reset password", 'error', 'Error');
    } else {
